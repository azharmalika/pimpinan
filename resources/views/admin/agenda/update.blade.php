    ...
    <div class="card-body">
        <form action="{{ route('agendaUpdate', $agenda->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="judul" value="{{ $agenda->judul }}" class="form-control @error ('judul') is-invalid @enderror">
            </div>

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="tanggal_mulai">Tanggal & Waktu Mulai</label>
                    <input type="datetime-local" name="tanggal_mulai" value="{{ $agenda->tanggal_mulai }}"class="form-control" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="tanggal_selesai">Tanggal & Waktu Selesai</label>
                    <input type="datetime-local" name="tanggal_selesai" value="{{ $agenda->tanggal_selesai }}" class="form-control" required>
                </div>
            </div>
